...
public class UserController extends CommonController {
    ...
    public ModelAndView usersEdit(Model model, final RedirectAttributes redirectAttributes,
    ...
    public ModelAndView store(Model model, final RedirectAttributes redirectAttributes,
        ...
        // redirectAttributes.addFlashAttribute(BINDING_RESULT + user_KEY, bindingResult);
