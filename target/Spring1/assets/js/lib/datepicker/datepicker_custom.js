...
(function(factory){
	...
	var Datepicker = function(element, options){
		...
		if (this.o.calendarWeeks) {
			this.picker.find('.datepicker-days .datepicker-switch, thead .datepicker-title, tfoot .action')
	...
	Datepicker.prototype = {
	  ...
	  var localDate = this._utc_to_local(this.viewDate);
		...
		fill: function(){
			...
			var isShowFooter = (this.o.todayBtn !== false || this.o.clearBtn !== false);
			this.picker.find('tfoot .action').toggle(isShowFooter);
			// If one of two element is shown, set its width 100%.
			if (isShowFooter && !(this.o.todayBtn !== false && this.o.clearBtn !== false)) {
				this.picker.find('tfoot tr th div').width('100%');
			}
